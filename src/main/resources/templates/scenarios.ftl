...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td class="content">
            <#list scenario.content as contentLine>
                            ${contentLine}
                        </#list>

        </td>
        <td><button data-scenario="${scenario.title?html}" data-scenario-content="${((scenario.content)?join("\n"))?html}" data-toggle="modal" data-target="#scenario-editor" class="btn btn-default scenario-edit"/><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
    </tr>
    <#else>
    <tr>
